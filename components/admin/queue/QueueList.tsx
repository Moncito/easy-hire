    ...
    <div className="overflow-hidden rounded-2xl border border-ink/5 bg-white admin-dark:border-white/10 admin-dark:bg-white/5">
      <div className="max-h-[65vh] overflow-y-auto">
        <table className="w-full table-fixed border-collapse text-sm">
          <thead className="sticky top-0 z-10 bg-mist/95 backdrop-blur-sm admin-dark:bg-admin-dark-surface/95">
            <tr className="border-b border-ink/10 text-left text-[10px] font-bold uppercase tracking-wider text-ink/45 admin-dark:border-white/10 admin-dark:text-mist/45">
              ...
              <th scope="col" className="w-14 px-2 py-1.5 text-right">
                Age
              </th>
            </tr>
          </thead>
            ...
            {items.map((item) => {
              ...
              return (
                <tr
                  ...
                  tabIndex={-1}
                  className={`h-8 cursor-pointer border-b border-ink/5 text-ink/80 transition-colors admin-dark:border-white/8 admin-dark:text-mist/80 ${rowStateClasses}`}
