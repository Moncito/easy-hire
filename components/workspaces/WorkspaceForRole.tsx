...
export type WorkspaceSection = "overview" | "queue" | "interviews" | "notifications";
...
export default function WorkspaceForRole({ companyId, role, active, children }: { companyId: string; role: CompanyMemberRole; active: WorkspaceSection; children: React.ReactNode }) {
  ...
  return <WorkspaceFrame sidebar={sidebar} queueHref={`/hiring/${companyId}/queue`}>{children}</WorkspaceFrame>;
}
